											...
											$
													.each(
															...
															function(index, obj) {
																...
																console
																		.log(obj.company.name.content); // company title

																console
																		.log(obj.position.title); // job title 

																console
																		.log(obj.position["required-education-level"].content); // 志願資格 

																console
																		.log(obj.position["job-type"].content); // 勤務条件

																console
																		.log(obj.salary.content); // 勤務条件,給与 

																console
																		.log(obj["expiration-timestamp"]); // 締め切り日 
