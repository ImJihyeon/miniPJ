...
public class JFrame_BookRent extends JFrame {//implements ActionListener{
	...
	public JFrame_BookRent() {
		...
		mem_id = new JLabel("회원 ID :     "); mem_id1 = new JTextField(Login.dtou.getId(),20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ( a1.length() == 0) {
					...
					if ( id.equals("admin") ) {
						...
						dmb.ManagerBookRent(a1, a2, a3, a4);
						dispose();
					} else {
