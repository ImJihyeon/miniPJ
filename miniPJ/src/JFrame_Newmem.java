...
public class JFrame_Newmem extends JFrame implements ActionListener {
	Login login;
	DAOMember memDAO;
	...
	JButton check_btn, join_btn, cancel_btn,delete_btn;
	Connection conn;
	...
	JFrame_Newmem() {
		...
		pan8.setPreferredSize(new Dimension(110, 100));
		pan8.add(name_label);
		pan8.add(id_label);
		pan8.add(pw_label);
		pan8.add(pw2_label);
